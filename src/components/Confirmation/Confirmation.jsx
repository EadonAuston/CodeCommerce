...
// import '../../assetsCopy/amex.png'
// import '../../assetsCopy/discover.png'
// import '../../assetsCopy/masterCard.png'
// import '../../assetsCopy/visa.png'
      ...
      return (
         ...
         <div className={style.confirmConfirm}>
            ...
            <hr />
             ...
             <FontAwesomeIcon icon={faCircleCheck} className={`${style.confirmCircle} ${style.confirmCircleBorder}`}/>
            
           
            <h1 className={style.tac}>Congratulations. <br /> Your order is accepted.</h1>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Esse veritatis inventore delectus velit, laborum fuga! Aspernatur officiis ipsum tempore consequuntur optio?</p>
        ...
        <img src={CARDICON[`${this.props.cardType}`]} alt="It didn't work" width='50px'/>
            <div className={style.cardType}>{`${this.props.cardType} ending in ...${this.getLastFourDigits(this.props.cardNumber)}`}</div> 
            <p>Total Payment: ${this.props.cartTotal}</p>
        </div>
